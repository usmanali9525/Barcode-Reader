...
image_path = "Images/barcodereader.png"
...
def decode_barcode(image):
    ...
    blurred_image = cv2.GaussianBlur(gray_image, (9, 9), 0) # Apply Gaussian blur to reduce noise (adjust the kernel size as needed)
